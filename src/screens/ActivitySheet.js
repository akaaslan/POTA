...
var ACTIVITIES = [
...
];
  {
    id: 'a2',
    actor: 'THUNDER_41',
    action: 'maç oluşturdu',
    target: 'BAKIRKÖY ELİT RUN',
    time: '8 dk önce',
    type: 'create',
    district: 'Bakırköy',
  },
  ...
  },
  {
    id: 'a4',
    actor: 'KRAL_34',
    action: 'GALİBİYET kazandı',
    target: 'CADDEBOSTAN RUN',
    time: '1 sa önce',
    type: 'win',
    district: 'Kadıköy',
  },
